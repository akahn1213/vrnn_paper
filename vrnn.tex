...
The loss function of the AE can be any function of the form $L({\textbf x}, {\textbf y}=g(f({\textbf x})))$, which 
...
The VAE reconstruction error is chosen to be the mean-squared-error loss as used in the ordinary AE.
