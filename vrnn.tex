...
\caption{Jet Boosting Algorithm. All \textit{while} loops are run at least once, regardless of if its conditions are met.}
\label{alg:boost}
\end{algorithm}
